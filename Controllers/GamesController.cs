...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
       ...
       .FirstOrDefaultAsync(g => g.Id == id);
            ...
            // Filtrer celles qui ne sont pas déjà associées au jeu
            var availablePlatforms = allPlatforms
                .Where(p => !game.Platforms.Any(gp => gp.Id == p.Id))
                .ToList();

            ViewBag.Platforms = new SelectList(availablePlatforms, "Id", "Name");
        ...
        public async Task<IActionResult> AddPlatform(int id, int platformId)
        {
            ...
            // Vérifier si la plateforme est déjà associée
